...
HD_PWD='/home/merl-lab/Documents/Vivado Projects/azadi/azadi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log azadi_soc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source azadi_soc_top.tcl
