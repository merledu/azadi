...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi4) {
  public:
    // CELLS
    VAzadi_top_verilator_tlul_fifo_sync__RCz4_RDz4* __PVT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo;
    VAzadi_top_verilator_tlul_fifo_sync__RCz4_RDz4* __PVT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo;
  ...
  public:
    void _sequent__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__44(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _settle__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__17(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _settle__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__26(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _settle__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__35(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    ...
    void _settle__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__XBAR_PERI__8(VAzadi_top_verilator__Syms* __restrict vlSymsp);
  private:
