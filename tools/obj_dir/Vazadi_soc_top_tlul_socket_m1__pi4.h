...
#ifndef _VAZADI_SOC_TOP_TLUL_SOCKET_M1__PI4_H_
#define _VAZADI_SOC_TOP_TLUL_SOCKET_M1__PI4_H_  // guard
...
VL_MODULE(Vazadi_soc_top_tlul_socket_m1__pi4) {
  public:
    // CELLS
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vazadi_soc_top_tlul_socket_m1__pi4);  ///< Copying not allowed
  public:
    Vazadi_soc_top_tlul_socket_m1__pi4(const char* name = "TOP");
