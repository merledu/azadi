...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi7) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 2 4 5 6 11 25 26 29 30 36 44 48 
    VL_OUTW(tl_d_o,85,0,3);
    // Begin mtask footprint all: 11 24 25 35 
    VL_OUT64(tl_h_o[2],51,0);
    // Begin mtask footprint all: 
    VL_IN64(tl_d_i,51,0);
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 4 19 24 25 29 43 
    VL_INW(tl_h_i[2],85,0,3);
    
    // LOCAL SIGNALS
    // Begin mtask footprint all: 4 24 25 26 29 36 43 44 48 
    WData/*85:0*/ __PVT__hreq_fifo_o[2][3];
    // Begin mtask footprint all: 4 25 26 29 36 44 48 
    CData/*1:0*/ __PVT__dfifo_rspready;
    // Begin mtask footprint all: 4 25 26 29 36 48 
    WData/*85:0*/ __PVT__dreq_fifo_i[3];
    // Begin mtask footprint all: 4 11 24 25 26 29 35 36 48 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__winner;
    // Begin mtask footprint all: 4 6 11 19 21 24 25 26 29 35 36 44 48 
    QData/*51:0*/ __PVT__drsp_fifo_o;
    // Begin mtask footprint all: 4 6 11 19 21 24 25 26 29 36 44 48 
    CData/*1:0*/ __PVT__hrequest;
    // Begin mtask footprint all: 4 6 11 19 21 24 25 29 44 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__mask;
    // Begin mtask footprint all: 4 6 11 19 21 24 25 29 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__ppc_out;
    // Begin mtask footprint all: 4 11 24 25 29 
    CData/*0:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__idx_o;
    // Begin mtask footprint all: 4 11 24 25 29 44 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__arb_req;
    // Begin mtask footprint all: 4 24 25 29 44 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__masked_req;
    // Begin mtask footprint all: 4 24 25 29 43 
    ...
    // Begin mtask footprint all: 4 11 24 25 35 
    QData/*51:0*/ __PVT__hrsp_fifo_i[2];
    CData/*1:0*/ __PVT__hgrant;
    // Begin mtask footprint all: 4 6 11 24 25 35 
  ...
  public:
    ...
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DEBUG_ROM__156(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__TIMER_0__162(VAzadi_top_verilator__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _sequent__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__158(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _sequent__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__TIMER_1__157(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _sequent__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__XBAR_PERI__160(VAzadi_top_verilator__Syms* __restrict vlSymsp);
