...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi7) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 10 19 32 33 37 40 
    VL_OUT64(tl_h_o[2],51,0);
    // Begin mtask footprint all: 
    VL_IN64(tl_d_i,51,0);
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 32 33 36 45 49 
    VL_INW(tl_h_i[2],85,0,3);
    // Begin mtask footprint all: 7 9 12 13 16 32 33 34 36 37 39 45 49 
    VL_OUTW(tl_d_o,85,0,3);
    
    // LOCAL SIGNALS
    // Begin mtask footprint all: 32 33 34 36 39 45 49 
  ...
  public:
    ...
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__164(VAzadi_top_verilator__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    void _settle__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__124(VAzadi_top_verilator__Syms* __restrict vlSymsp) VL_ATTR_COLD;
