...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi7) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 3 5 6 7 10 26 27 29 30 31 34 39 
    VL_OUTW(tl_d_o,85,0,3);
    // Begin mtask footprint all: 26 29 31 34 39 
    VL_INW(tl_h_i[2],85,0,3);
    // Begin mtask footprint all: 
    VL_IN64(tl_d_i,51,0);
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 6 7 26 35 
    VL_OUT64(tl_h_o[2],51,0);
    
    // LOCAL SIGNALS
    // Begin mtask footprint all: 26 27 29 30 31 34 39 
  ...
  public:
    ...
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__PLIC__159(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__TIMER_0__158(VAzadi_top_verilator__Syms* __restrict vlSymsp);
