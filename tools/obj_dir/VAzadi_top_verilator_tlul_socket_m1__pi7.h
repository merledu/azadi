...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi7) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 4 6 14 15 28 29 30 31 32 43 
    VL_OUTW(tl_d_o,85,0,3);
    // Begin mtask footprint all: 28 29 31 32 39 41 43 
    VL_INW(tl_h_i[2],85,0,3);
    // Begin mtask footprint all: 
    VL_IN64(tl_d_i,51,0);
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 10 14 28 39 
    VL_OUT64(tl_h_o[2],51,0);
    
    // LOCAL SIGNALS
    // Begin mtask footprint all: 10 14 15 28 29 30 31 32 39 43 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__winner;
    // Begin mtask footprint all: 15 28 29 30 31 32 39 43 
    WData/*85:0*/ __PVT__hreq_fifo_o[2][3];
    // Begin mtask footprint all: 15 28 29 30 31 32 43 
    WData/*85:0*/ __PVT__dreq_fifo_i[3];
    CData/*1:0*/ __PVT__dfifo_rspready;
    // Begin mtask footprint all: 28 29 31 32 39 43 
