...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi7) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 1 2 7 10 12 18 27 28 29 30 35 36 39 
    VL_OUTW(tl_d_o,85,0,3);
    // Begin mtask footprint all: 27 28 30 36 39 
    VL_INW(tl_h_i[2],85,0,3);
    // Begin mtask footprint all: 
    VL_IN64(tl_d_i,51,0);
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 4 12 27 34 
    VL_OUT64(tl_h_o[2],51,0);
    
    // LOCAL SIGNALS
    // Begin mtask footprint all: 4 12 18 27 28 29 30 34 36 39 
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__winner;
    // Begin mtask footprint all: 18 27 28 29 30 36 39 
  ...
  public:
    ...
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__159(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    ...
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__TIMER_0__160(VAzadi_top_verilator__Syms* __restrict vlSymsp);
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__TIMER_3__153(VAzadi_top_verilator__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    void _settle__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DCCM__85(VAzadi_top_verilator__Syms* __restrict vlSymsp) VL_ATTR_COLD;
