...
VL_MODULE(VAzadi_top_verilator_tlul_socket_m1__pi7) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 4 6 8 11 19 20 28 29 30 31 32 33 40 
    VL_OUTW(tl_d_o,85,0,3);
    // Begin mtask footprint all: 28 29 30 31 32 38 40 
    VL_INW(tl_h_i[2],85,0,3);
    // Begin mtask footprint all: 
    VL_IN64(tl_d_i,51,0);
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 4 8 28 29 33 
    VL_OUT64(tl_h_o[2],51,0);
    
    // LOCAL SIGNALS
    // Begin mtask footprint all: 20 28 29 30 31 32 40 
    WData/*85:0*/ __PVT__hreq_fifo_o[2][3];
    WData/*85:0*/ __PVT__dreq_fifo_i[3];
    CData/*1:0*/ __PVT__dfifo_rspready;
    // Begin mtask footprint all: 28 29 30 31 32 40 
  ...
  public:
    ...
    void _combo__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__DEBUG_ROM__159(VAzadi_top_verilator__Syms* __restrict vlSymsp);
  ...
  public:
    void _sequent__TOP__Azadi_top_verilator__DOT__top_verilator__DOT__main_swith__DOT__TIMER_0__154(VAzadi_top_verilator__Syms* __restrict vlSymsp);
