...
#ifndef _VAZADI_TOP_VERILATOR_UART_REG_PKG_H_
#define _VAZADI_TOP_VERILATOR_UART_REG_PKG_H_  // guard
...
VL_MODULE(VAzadi_top_verilator_uart_reg_pkg) {
  public:
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(VAzadi_top_verilator_uart_reg_pkg);  ///< Copying not allowed
  public:
    VAzadi_top_verilator_uart_reg_pkg(const char* name = "TOP");
  ...
  public:
    static void _initial__TOP__uart_reg_pkg__1(VAzadi_top_verilator__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
