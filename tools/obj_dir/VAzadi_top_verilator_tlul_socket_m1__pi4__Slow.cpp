...
VL_CTOR_IMP(VAzadi_top_verilator_tlul_socket_m1__pi4) {
    VL_CELL(__PVT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo, VAzadi_top_verilator_tlul_fifo_sync__RCz2_RDz2);
    VL_CELL(__PVT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo, VAzadi_top_verilator_tlul_fifo_sync__RCz2_RDz2);
